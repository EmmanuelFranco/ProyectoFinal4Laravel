  ...
  return (
    <div className="container mx-auto">
      ...
      <button
        ...
        className="bg-gray-500 text-white px-4 py-2 rounded-md mb-4 hover:bg-gray-600 focus:outline-none focus:ring focus:border-gray-300"
      >
        Atrás
      </button>
      {loading ? (
        <p>Cargando Bitacoras...</p>
      ) : (
